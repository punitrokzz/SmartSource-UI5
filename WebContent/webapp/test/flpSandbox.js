		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Smart Source",
									"targetURL": "#smartsourceapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"smartsourceapp-display": {
								"semanticObject": "smartsourceapp",
								"action": "display",
								"description": "Smart Source frontend application",
								"title": "Smart Source",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=smartsourceapp",
									"url": sap.ui.require.toUrl("smartsourceapp")
								}
							}
						}
					}
